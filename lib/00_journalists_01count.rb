...
# puts journalists.length et puts journalists.size fonctionnent aussi

# Mesure de la longueur d'une chaine :  string.size ou string.length

# Sortir la plus petite handle
i = 1
journalist_min = journalists.bsearch {|x| x.size <= i}

i = 2

while (journalist_min.is_a? String) != true
    journalist_min = journalists.bsearch {|x| x.size <= i}
    i = i+1
end
...
# puts journalist_min
# puts journalists.bsearch {|x| x.size <= 8}


# puts journalists.

# journalist.each {|pseudo| print pseudo.length}


# parcourir le tableau, 
#     enregistrer la taille du 1er dans une variable min_size
#     passer à l'élément suivant
#     vérifier si la taille de l'élément est inférieure à celle de l'élément précédent 
#   Si oui, la size est enregistrée dans min_size
#   Et continuer jusqu'à la fin du tableau
